...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        {
          imageSrc: "http://img.b2bpic.net/free-photo/flat-lay-composition-tasty-donuts_23-2148194234.jpg",
          imageAlt: "Fresh mochi donuts display",
        },
        {
          imageSrc: "http://img.b2bpic.net/free-photo/fresh-yummy-white-chocolate-donuts-red-background_23-2147895888.jpg",
      ...
      features={[
        {
          ...
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-different-ingredients-cips-flakes-nuts-grey-background-meal-snack-breakfast-color_140725-110132.jpg",
        },
        {
