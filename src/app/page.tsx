...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        { imageSrc: "http://img.b2bpic.net/free-photo/flat-lay-composition-tasty-donuts_23-2148194234.jpg?_wi=1", imageAlt: "Fresh mochi donuts display" },
        { imageSrc: "http://img.b2bpic.net/free-photo/fresh-yummy-white-chocolate-donuts-red-background_23-2147895888.jpg?_wi=1", imageAlt: "Signature mochi donut" },
        { imageSrc: "http://img.b2bpic.net/free-photo/fried-chicken-meat-seafood-barbecue-with-vegetables-wooden-skewers-plate-sauce-top-view_1253-954.jpg?_wi=1", imageAlt: "Traditional yakitori skewers" },
  ...
  <div id="features" data-section="features">
      ...
      useInvertedBackground={false}
      features={[
        { title: "Signature Mochi Donuts", description: "Chewy, airy, and full of flavor.", imageSrc: "http://img.b2bpic.net/free-photo/front-view-different-ingredients-cips-flakes-nuts-grey-background-meal-snack-breakfast-color_140725-110132.jpg?_wi=1" },
